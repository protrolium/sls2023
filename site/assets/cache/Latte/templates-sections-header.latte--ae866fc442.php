...
final class Templateae866fc442 extends Latte\Runtime\Template
{
    ...
    <div class="uk-width-1-1" id="menu" uk-offcanvas="mode: none;">
        <button class="uk-close-large uk-offcanvas-close" type="button" aria-label="Close" uk-close></button>
        
        <div class="uk-offcanvas-bar uk-width-1-1">
            <nav id="tm-menu" class="uk-flex-center tm-boxed-padding" uk-navbar>
                <div class="uk-navbar">
